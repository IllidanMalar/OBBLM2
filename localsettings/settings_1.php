 ...
 *   General
 *********************/ 
require_once('sperimentale.php');
$TESTI = new Sperimentale();

$settings['league_name']     = 'Lega Sviluppo'; // Name of the site or the league name if only one league is being managed.
...
$settings['league_url_name'] = 'League URL disabled';   // Button text for league URL.
...
$settings['lang']            = 'it-IT';            // Default language. Existing: en-GB, es-ES, de-DE, fr-FR, it-IT.
$settings['fp_links']        = true;               // Default is true. Generate coach, team and player links on the front page?
$settings['welcome']         = $TESTI->welcome;
$settings['rules']           = $TESTI->rules;
$settings['more_buttons']    = 0;
$settings['more_buttons_text'] = array('Prova 1', 'Google');
$settings['more_buttons_url'] = array('http://www.libero.it', 'http://www.google.it');
...
$settings['fp_standings'] = array(
    ...
    array(
        ...
        */
        ...
        'fields' => array('Nome' => 'name', 'PTS' => 'pts', 'TV' => 'tv', 'DMete' => 'sdiff', 'DCas' => 'tcdiff', 'SPORT' => 'smp',),
    ),
);
...
$settings['fp_leaders'] = array(
    ...
    array(
        ...
        // Please note: 'type' may be either one of: 'league', 'division' or 'tournament'
        'type'      => 'tournament', # This sets the node to be a tournament. I.e. this will make a leaders box for the tournament with ID = 1
        'title'     => 'Realizzatori', # Table title
...
$settings['fp_events'] = array(
    ...
    */
    array(
        ...
        'title'     => 'Ultimi decessi', # Table title
    ...
    array(
        ...
        // Please note: 'type' may be either one of: 'league', 'division' or 'tournament'
        'type'      => 'tournament', # This sets the node to be a tournament. I.e. this will make an event box for the tournament with ID = 1
        'title'     => 'Piccole schiappe crescono', # Table title
...
$settings['fp_latestgames'] = array(
    ...
    array(
        ...
        'box_ID' => 2,
        // Please note: 'type' may be either one of: 'league', 'division' or 'tournament'
        'type'   => 'tournament', # This sets the node to be a league. I.e. this will make a latest games box for the league with ID = 1
        'title'  => 'Partite recenti', # Table title
        'length' => 5, # Number of entries in table
    ),
);