...
function sec_main() {
    ...
    ?>
    <div class="main_head page-header col-xs-12 hidden-xs">
    	<?php if(count($leagues) > 1) {
    		echo "<div class='selettoreLega'>";	
    		echo $HTML_LeagueSelector;
			echo "</div>";
		} ?>
    	<h1><?php echo $settings['league_name']; ?></h1>
    </div>
    <div class='main_leftColumn col-xs-12 col-sd-6 col-md-4'>
    	<div class="main_leftColumn_head">
        
        	
        	<div class="panel panel-primary main_leftColumn_welcome">
        		<div class="panel-heading">
        			<h3 class="panel-title">Welcome</h3>
        		</div>
        		<div class="panel-body">
        			<p class="text-justify"><?php echo $settings['welcome']; ?></p>
        		</div>
        		<?php // <div class="panel-footer">Panel footer</div> ?>
        	</div>
            ...
            <div style="display:none; clear:both;" id="msgnew">
                <form method="POST">
                	<div class="form-group">
                    	...
                    	<textarea name="title" rows="1" cols="50" class="form-control" style="resize: none;"><?php echo $lng->getTrn('common/notitle');?></textarea>
                    </div>
                    <div class="form-group">
    					<label for="txt">Testo</label>
                    	<textarea name="txt" rows="15" cols="50" class="form-control" style="resize: none;"><?php echo $lng->getTrn('common/nobody');?></textarea>
                    </div>
                    <?php if ($IS_GLOBAL_ADMIN) { ?>
						<div class="checkbox">
							<label>
								<input type="checkbox" name="BC"> <?php echo $lng->getTrn('main/broadcast'); ?>
						    </label>
						</div>
                    <?php } ?>
                    <input type="hidden" name="type" value="msgnew">
                    <button type="submit" class="btn btn-default"><?php echo $lng->getTrn('common/submit');?></button>
                    <?php /* <input type="submit" value="<?php echo $lng->getTrn('common/submit');?>"> */ ?>
                </form>
            </div>
    ...
    */
    ...
    echo "<div class='main_rightColumn col-xs-12 col-sd-6 col-md-8'>\n";
...
function sec_rosters() {
    title('Rosters');
    Roster_HTMLOUT::dispList();
}
